...
public class Main extends AppCompatActivity {
    ...
    Button btn;
    TextView tempVal;
    String accion = "nuevo", idHabito = "", id="", rev="";
    ImageView img;
    ...
    private void mostrarDatos(){
        try {
            ...
            if (accion.equals("modificar")) {
                ...
                idHabito = datos.getString("idAmigo");
    ...
    private void tomarFoto(){
        img.setOnClickListener(view->{
            ...
            try{
                ...
                if( fotoAmigo!=null ){
                    Uri uriFotoAimgo = FileProvider.getUriForFile(Main.this,
    ...
    private void abrirVentana(){
        Intent intent = new Intent(this, lista_habitos.class);
    ...
    private void guardarAmigo() {
        try {
            ...
            habitos habito = new habitos(idHabito, nombre, direccion, telefono, email, dui, urlCompletaFoto, getUrlCompletaFotoFirestore, miToken);
            if( key!= null ){
                databaseReference.child(key).setValue(habito).addOnSuccessListener(success->{
